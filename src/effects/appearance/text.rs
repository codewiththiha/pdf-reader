...
//! of the pipeline is one pure step: recomputing the page palette (with
//! the ink dial resolved in Rust, not in the stylesheet).
...
/// (0..=100). Always painted alongside the PDF token set — the two
