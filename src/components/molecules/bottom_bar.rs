//! Auto-hide bottom bar: the displaced PageNav (prev/next + page input) and,
...
#[component]
pub fn BottomBar(state: AppState) -> impl IntoView {
    ...
    view! {
        ...
        // grabable while the bar is hidden. PageNav itself renders "– / –"
